...
<img src="/docs/architecture-flow.svg" alt="Golems Architecture — Data flow between local Mac and Railway cloud" style={{width:'100%',borderRadius:'12px',margin:'1.5rem 0'}} />
