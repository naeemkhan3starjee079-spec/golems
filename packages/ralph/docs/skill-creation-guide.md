...
### Pattern 1: Conditional Workflow Selection
...
|-------------------|-----------|
| Create a new issue | [workflows/issues.md#create](workflows/issues.md#create) |
| Close an issue | [workflows/issues.md#close](workflows/issues.md#close) |
| Create a PR | [workflows/pull-requests.md#create](workflows/pull-requests.md#create) |
| Merge a PR | [workflows/pull-requests.md#merge](workflows/pull-requests.md#merge) |
```

### Pattern 2: Feedback Loop for Quality
...
2. **VALIDATE before commit:**
   ...
   If validation fails → fix issues → return to step 1
...
4. **VERIFY after commit:**
   ...
   If wrong files included → `git reset HEAD~1` → return to step 1
```

### Pattern 3: Domain-Specific Reference Files

```
reference/
├── finance/
│   ├── schemas.md      # Only loaded for finance queries
│   └── metrics.md
├── sales/
│   ├── schemas.md      # Only loaded for sales queries
│   └── pipelines.md
└── product/
    └── analytics.md    # Only loaded for product queries
```
...
- **Finance queries**: See [reference/finance/](reference/finance/)
- **Sales queries**: See [reference/sales/](reference/sales/)
- **Product queries**: See [reference/product/](reference/product/)
```
...
If "Bad credentials" → See [workflows/troubleshooting.md](workflows/troubleshooting.md)
```
