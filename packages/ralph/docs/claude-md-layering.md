...
**Important:** Add `.claude/` to `.gitignore` to keep personal overrides out of version control.
...
```markdown
# My Overrides for <project-name>

---

## Personal Preferences

<overrides that differ from team standards>
