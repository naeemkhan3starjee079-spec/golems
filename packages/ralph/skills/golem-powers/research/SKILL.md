...
4. **Read results** when notified — researcher saves to `/tmp/research-[slug].md`
5. **Move to permanent location** if worth keeping: `docs.local/research/[date]-[slug].md`
...
~/.claude/commands/golem-powers/cli-agents/scripts/run.sh gemini "Research: {full prompt}" /tmp/research-output.md
```
