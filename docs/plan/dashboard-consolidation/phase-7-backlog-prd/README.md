...
1. **Add "ideas" column to backlog** — New status column before "Backlog": raw ideas that haven't been planned yet. User can say "add this idea" and it lands here.
...
5. **Quick-add from dashboard** — Floating "+" button or keyboard shortcut to quickly add ideas. Title + project + optional priority.
6. **Filter by plan** — Add plan filter to Kanban board. Show all items for a specific plan.
