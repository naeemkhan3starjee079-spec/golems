...
## Core Skills (golem-powers)

| Skill | Description |
|-------|-------------|
| `/golem-powers:prd` | Generate PRDs for Ralph |
| `/golem-powers:github` | Git/GitHub CLI operations |
| `/golem-powers:linear` | Linear issue management |
...
| `/golem-powers:critique-waves` | Multi-agent consensus verification |
...
See [Skill Creation Guide](./advanced/skill-creation-guide.md) for the full pattern.
