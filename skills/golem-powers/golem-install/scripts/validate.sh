...
# Section: Skills (individual symlinks in ~/.claude/commands/)
echo "=== Skill Symlinks ==="
check "github skill symlink" "test -L ~/.claude/commands/github"
check "linear skill symlink" "test -L ~/.claude/commands/linear"
...
check "coderabbit skill symlink" "test -L ~/.claude/commands/coderabbit"
echo ""
...
if [ $FAIL -eq 0 ]; then
    ...
    echo "  2. Test with: /github or /1password"
    exit 0
else
    echo ""
